...
public class SubmitFeedSample {
    ...
    public static void main(String... args) {
         ...
         * http://aws.amazon.com
         ***********************************************************************/
        final String accessKeyId = "AKIAIZLW7DKQWH3E2GPA";
        final String secretAccessKey = "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";

        final String appName = "Sunshades Depot";
         ...
         ***********************************************************************/
        final String merchantId = "A1WE4ARVMYN2BL";
        ...
        xml.append("<MerchantIdentifier>Sunshades Depot</MerchantIdentifier>");
        xml.append("</Header>");
        xml.append("<MessageType>OrderFulfillment</MessageType>");
        xml.append("<Message>");
        xml.append("<MessageID>1</MessageID>");
        xml.append("<OrderFulfillment>");
        xml.append("<AmazonOrderID>103-6651079-1277000</AmazonOrderID>");
